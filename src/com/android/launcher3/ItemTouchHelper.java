...
/**
 * Created by qi.tao on 2017/1/10.
 * <p/>
 ...
 * {@link Callback#onMove(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, android.support.v7.widget.RecyclerView.ViewHolder)} and / or
 * {@link Callback#onSwiped(android.support.v7.widget.RecyclerView.ViewHolder, int)}.
 * <p/>
 ...
 * overriding {@link Callback#onChildDraw(Canvas, android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, float, float, int,
 * boolean)}
 * or {@link Callback#onChildDrawOver(Canvas, android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, float, float, int,
 * boolean)}.
 * <p/>
...
public class ItemTouchHelper extends android.support.v7.widget.RecyclerView.ItemDecoration
     ...
     */
    android.support.v7.widget.RecyclerView.ViewHolder mSelected = null;
     ...
     * {@link Callback#getAbsoluteMovementFlags(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)} for the current
     * action state.
     */
    int mSelectedFlags;
    ...
    private List<android.support.v7.widget.RecyclerView.ViewHolder> mSwapTargets;
     ...
     */
    private android.support.v7.widget.RecyclerView.ChildDrawingOrderCallback mChildDrawingOrderCallback = null;
    ...
    private final android.support.v7.widget.RecyclerView.OnItemTouchListener mOnItemTouchListener
        ...
        @Override
        public boolean onInterceptTouchEvent(android.support.v7.widget.RecyclerView recyclerView, MotionEvent event) {
        ...
        @Override
        public void onTouchEvent(android.support.v7.widget.RecyclerView recyclerView, MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (DEBUG) {
                Log.d(TAG,
     ...
     * {@link #attachToRecyclerView(android.support.v7.widget.RecyclerView)}. Upon attaching, it will add an item decoration,
     ...
     *                     RecyclerView.
     */
    public void attachToRecyclerView(@Nullable android.support.v7.widget.RecyclerView recyclerView) {
        ...
        mRecyclerView.post(new Runnable() {
            ...
            public void run() {
                if (mRecyclerView != null && mRecyclerView.isAttachedToWindow() &&
                        !anim.mOverridden &&
                        anim.mViewHolder.getAdapterPosition() != android.support.v7.widget.RecyclerView.NO_POSITION) {
                    final android.support.v7.widget.RecyclerView.ItemAnimator animator = mRecyclerView.getItemAnimator();
    ...
    private List<android.support.v7.widget.RecyclerView.ViewHolder> findSwapTargets(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        if (mSwapTargets == null) {
            mSwapTargets = new ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>();
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final android.support.v7.widget.RecyclerView.ViewHolder otherVh = mRecyclerView.getChildViewHolder(other);
    ...
    void moveIfNecessary(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        ...
        List<android.support.v7.widget.RecyclerView.ViewHolder> swapTargets = findSwapTargets(viewHolder);
        if (swapTargets.size() == 0) {
            return;
        }
        // may swap.
        android.support.v7.widget.RecyclerView.ViewHolder target = mCallback.chooseDropTarget(viewHolder, swapTargets, x, y);
        if (target == null) {
            mSwapTargets.clear();
            mDistances.clear();
            return;
    ...
    public void onChildViewDetachedFromWindow(View view) {
        ...
        final android.support.v7.widget.RecyclerView.ViewHolder holder = mRecyclerView.getChildViewHolder(view);
        if (holder == null) {
            return;
        }
     ...
     */
    int endRecoverAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
    ...
    private int checkHorizontalSwipe(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int flags) {
    ...
    private int checkVerticalSwipe(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int flags) {
        if ((flags & (UP | DOWN)) != 0) {
     ...
     * {@link #getMovementFlags(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)} and return appropriate set
     ...
     * {@link Callback#onMove(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, android.support.v7.widget.RecyclerView.ViewHolder)
     ...
     * in your adapter and also call {@link android.support.v7.widget.RecyclerView.Adapter#notifyItemMoved(int, int)}.
     * To control where a View can be dropped, you can override
     * {@link #canDropOver(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, android.support.v7.widget.RecyclerView.ViewHolder)}. When a
     ...
     * {@link #chooseDropTarget(android.support.v7.widget.RecyclerView.ViewHolder, java.util.List, int, int)} to select a
     * custom drop target.
     * <p/>
     * When a View is swiped, ItemTouchHelper animates it until it goes out of bounds, then calls
     * {@link #onSwiped(android.support.v7.widget.RecyclerView.ViewHolder, int)}. At this point, you should update your
    ...
    public abstract static class Callback {
         ...
         */
        public abstract int getMovementFlags(android.support.v7.widget.RecyclerView recyclerView,
        ...
        final int getAbsoluteMovementFlags(android.support.v7.widget.RecyclerView recyclerView,
                                           android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            final int flags = getMovementFlags(recyclerView, viewHolder);
            return convertToAbsoluteDirection(flags, ViewCompat.getLayoutDirection(recyclerView));
        }

        boolean hasDragFlag(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (flags & ACTION_MODE_DRAG_MASK) != 0;
        }

        boolean hasSwipeFlag(android.support.v7.widget.RecyclerView recyclerView,
                             android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
         ...
         * passed to {@link #chooseDropTarget(android.support.v7.widget.RecyclerView.ViewHolder, java.util.List, int, int)}.
         * <p/>
         ...
         * otherwise.
         */
        public boolean canDropOver(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder current,
         ...
         * {@code target}.
         * @see #onMoved(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, int, android.support.v7.widget.RecyclerView.ViewHolder, int, int, int)
         */
        public abstract boolean onMove(android.support.v7.widget.RecyclerView recyclerView,
                                       android.support.v7.widget.RecyclerView.ViewHolder viewHolder, android.support.v7.widget.RecyclerView.ViewHolder target);
         ...
         * dragging on a custom view touch using {@link #startDrag(android.support.v7.widget.RecyclerView.ViewHolder)}.
         *
         ...
         * @see #startDrag(android.support.v7.widget.RecyclerView.ViewHolder)
         */
         ...
         * <p/>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(android.support.v7.widget.RecyclerView.ViewHolder)}.
         *
         * @return True if ItemTouchHelper should start swiping an item when user swipes a pointer
         * over the View, false otherwise. Default value is <code>true</code>.
         * @see #startSwipe(android.support.v7.widget.RecyclerView.ViewHolder)
         */
         ...
         * @see #getSwipeThreshold(android.support.v7.widget.RecyclerView.ViewHolder)
         */
         ...
         *                    {@link android.support.v7.widget.RecyclerView.ItemDecoration}s.
         ...
         * moved to.
         */
        public android.support.v7.widget.RecyclerView.ViewHolder chooseDropTarget(android.support.v7.widget.RecyclerView.ViewHolder selected,
                                                                                  List<android.support.v7.widget.RecyclerView.ViewHolder> dropTargets, int curX, int curY) {
            int right = curX + selected.itemView.getWidth();
            int bottom = curY + selected.itemView.getHeight();
            android.support.v7.widget.RecyclerView.ViewHolder winner = null;
            int winnerScore = -1;
            final int dx = curX - selected.itemView.getLeft();
            final int dy = curY - selected.itemView.getTop();
            final int targetsSize = dropTargets.size();
            for (int i = 0; i < targetsSize; i++) {
                final android.support.v7.widget.RecyclerView.ViewHolder target = dropTargets.get(i);
                if (dx > 0) {
         ...
         * {@link #getMovementFlags(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)} method, this method
         ...
         * {@link #clearView(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)}.
         *
         * @param viewHolder The ViewHolder which has been swiped by the user.
         * @param direction  The direction to which the ViewHolder is swiped. It is one of
         *                   {@link #UP}, {@link #DOWN},
         *                   {@link #LEFT} or {@link #RIGHT}. If your
         *                   {@link #getMovementFlags(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)}
         *                   method
         *                   returned relative flags instead of {@link #LEFT} / {@link #RIGHT};
         *                   `direction` will be relative as well. ({@link #START} or {@link
         *                   #END}).
         */
        public abstract void onSwiped(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int direction);
         ...
         * @see #clearView(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)
         */
        ...
        private int getMaxDragScroll(android.support.v7.widget.RecyclerView recyclerView) {
        ...
        /**
         * Called when {@link #onMove(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, android.support.v7.widget.RecyclerView.ViewHolder)} returns true.
         * <p/>
         ...
         * <p/>
         * Default implementation calls {@link android.support.v7.widget.RecyclerView#scrollToPosition(int)} if the View's
         ...
         *                     {@link android.support.v7.widget.RecyclerView.ItemDecoration}s.
         */
        public void onMoved(final android.support.v7.widget.RecyclerView recyclerView,
                            final android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int fromPos, final android.support.v7.widget.RecyclerView.ViewHolder target, int toPos, int x,
                            int y) {
            final android.support.v7.widget.RecyclerView.LayoutManager layoutManager = recyclerView.getLayoutManager();
        ...
        void onDraw(Canvas c, android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder selected,
        ...
        void onDrawOver(Canvas c, android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder selected,
                        List<ItemTouchHelper.RecoverAnimation> recoverAnimationList,
                        int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
         ...
         * {@link #onSelectedChanged(android.support.v7.widget.RecyclerView.ViewHolder, int)},
         * {@link #onChildDraw(Canvas, android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, float, float, int,
         * boolean)} or
         * {@link #onChildDrawOver(Canvas, android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, float, float, int, boolean)}.
         *
         ...
         * @see #onChildDrawOver(Canvas, android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder, float, float, int,
         * boolean)
         */
        public void onChildDraw(Canvas c, android.support.v7.widget.RecyclerView recyclerView,
                                android.support.v7.widget.RecyclerView.ViewHolder viewHolder,
         ...
         * boolean)
         */
        public void onChildDrawOver(Canvas c, android.support.v7.widget.RecyclerView recyclerView,
                                    android.support.v7.widget.RecyclerView.ViewHolder viewHolder,
                                    float dX, float dY, int actionState, boolean isCurrentlyActive) {
         ...
         * {@link android.support.v7.widget.RecyclerView.ItemAnimator#getMoveDuration()}, otherwise, it returns
         * {@link android.support.v7.widget.RecyclerView.ItemAnimator#getRemoveDuration()}. If RecyclerView does not have
         * any {@link android.support.v7.widget.RecyclerView.ItemAnimator} attached, this method returns
         ...
         */
        public long getAnimationDuration(android.support.v7.widget.RecyclerView recyclerView, int animationType,
                                         float animateDx, float animateDy) {
            final android.support.v7.widget.RecyclerView.ItemAnimator itemAnimator = recyclerView.getItemAnimator();
         ...
         * be passed to {@link android.support.v7.widget.RecyclerView#scrollBy(int, int)} method.
         */
        public int interpolateOutOfBoundsScroll(android.support.v7.widget.RecyclerView recyclerView,
    ...
    public abstract static class SimpleCallback extends Callback {
         ...
         * {@link #getSwipeDirs(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)}
         * and / or {@link #getDragDirs(android.support.v7.widget.RecyclerView, android.support.v7.widget.RecyclerView.ViewHolder)}.
         *
         ...
         */
        public int getSwipeDirs(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
         ...
         * @return A binary OR of direction flags.
         */
        public int getDragDirs(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
