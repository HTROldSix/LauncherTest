...
class ItemTouchUIUtilImpl {
    static class Lollipop extends Honeycomb {
        @Override
        public void onDraw(Canvas c, android.support.v7.widget.RecyclerView recyclerView, View view,
        ...
        private float findMaxElevation(android.support.v7.widget.RecyclerView recyclerView, View itemView) {
    ...
    static class Honeycomb implements ItemTouchUIUtil {
        ...
        @Override
        public void onDrawOver(Canvas c, android.support.v7.widget.RecyclerView recyclerView,
    ...
    static class Gingerbread implements ItemTouchUIUtil {
        ...
        private void draw(Canvas c, android.support.v7.widget.RecyclerView parent, View view,
                          float dX, float dY) {
            c.save();
            c.translate(dX, dY);
